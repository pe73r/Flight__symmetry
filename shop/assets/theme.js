...
theme.icons = {
  left: '<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><title>Left</title><path d="M0 0h24v24H0z" fill="none"/><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',
  right: '<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><title>Right</title><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>',
  close: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><title>Close</title><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',
  chevronLeft: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><title>Left</title><polyline points="15 18 9 12 15 6"></polyline></svg>',
  chevronRight: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><title>Right</title><polyline points="9 18 15 12 9 6"></polyline></svg>',
  chevronDown: '<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><title>Down</title><path d="M7.41 7.84L12 12.42l4.59-4.58L18 9.25l-6 6-6-6z"/><path d="M0-.75h24v24H0z" fill="none"/></svg>',
...
theme.HeaderSection = new function(){
  this.onSectionLoad = function(container){
              ...
              success: function(response){
                ...
                if($resultsRows.children().length > 0) {
                  ...
                  $resultsBox.addClass('results-box--has-results')
                    .append($resultsRows)
                    .append(['<a href="', linkURL, '" class="note">', "See all results", '</a>'].join(''));
                } else {
    ...
    theme.select2.init($('.logo-area .switcher select', container), {
      ...
      dropdownCssClass: 'select2-dropdown--theme-currency'
    });
  }
...
$(function($){
  ...
  $('<a href="#" class="mobile-nav-toggle" id="mobile-nav-return" aria-label="' + "Toggle menu" + '"></a>').appendTo('body');
      ...
      if($block.toggleClass('expanded').hasClass('expanded')) {
        ...
        if($sliderRow.length > 0) {
          ...
          if(noneExpanded) {
            ...
            theme.OptionManager.unloadProductOptions($('select[name="id"]', $quickbuyCont));
          ...
          $expandedSiblings.each(function(){
            ...
            // unload existing quickbuy
            theme.OptionManager.unloadProductOptions($('select[name="id"]', this));
        ...
        theme.currentQuickbuyRequest = $.get(url, function(response){
          ...
          $quickbuyCont.find('select[name="id"], input[name="id"]').trigger('optionate'); // 2
  ...
  $(document).on('submit', 'form[action^="/cart/add"]:not(.noAJAX)', function(e) {
      ...
      $.post(shopifyAjaxAddURL, $form.serialize(), function(itemData) {
          ...
          $.get(shopifyAjaxCartURL, function(cartData){
            ...
            subtotalHtml += '<span class="cart-summary-overlay__subtotal-mobile-title">' + "Subtotal" + ':</span> ';
